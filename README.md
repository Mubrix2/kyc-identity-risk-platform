...
The companion platform to the [Real-Time Fraud Detection Pipeline](../realtime-fraud-detection-pipeline).
...
Companion project: [Real-Time Fraud Detection Pipeline](#)